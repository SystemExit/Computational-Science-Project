...
**prep_results_plots.py and best_prep_plots.py and pie.py**  
...
All data used for generating plots can also be found under 'data/sim_results' and 'data/results_standard_mode', ready to use to generate plots. All plots seen in the poster's/report's 'results' can be generating by running these three files. (pie.py specifically works for network with network_seed=67, for class distributions of othr networks, the values in this code should be edited)
