...
- After downloading the zip-file, you can find the egodyads file under the name "22140-0002-Data.tsv" as follows":    
    ICPSR_22140-V1 -> ICPSR_22140 -> DS0002 -> 22140-0002-Data.tsv
- Place this file directly in the 'data' directory so that its path is 'data/22140-0002-Data.tsv' before running the code.

To inspect the metadata of the .tsv file one should take a look at "22140-0002-Codebook.pdf".
Morris, M., & Rothenberg, R. (2011). Hiv transmission network metastudy project: An archive of data from eight network stud
